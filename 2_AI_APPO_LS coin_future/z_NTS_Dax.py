...
#Input : vMultipleH1(11), CCI기간값1(12);
#Input : vMultipleH2(22), CCI기간값2(24);
#Input : vMultipleH3(43), CCI기간값3(48);
#Input : vMultipleH4(65), CCI기간값4(72);
#Input : vMultipleH5(78), CCI기간값5(84);
#Input : vMultipleH6(91), CCI기간값6(100);
#Input : vMultipleH7(30), CCI기간값7(2700);
#Input : vMultipleH8(120), CCI기간값8(3500);
...
class NTS_DAX_Env:
    ...
    def CCI(self, data, period):  # CCI 함수
        ...
        CCI_data = ((data - Aver) / (0.015 * (MD + (1e-5))))
    ...
    def NTS_Dax(self, vM1, CCI1, vM2, CCI2, vM3, CCI3, vM4, CCI4, vM5, CCI5, vM6, CCI6, vM7, CCI7, vM8, CCI8, STX_A,
